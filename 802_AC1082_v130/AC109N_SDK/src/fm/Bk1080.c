...
/*
const u16 HW_Reg[] AT(BK1080_TABLE_CODE)=
{
    0x0008,
    0x1080,
#if XTAL_CLOCK	//reg2
...
*/
/*----------------------------------------------------------------------------*/
static void BEKEN_I2c_Read(u8 reg, u8 *pBuf, u8 num) AT(BK1080_CODE)
{
    reg = reg<<1;
    reg |= 0x01;
...
*/
/*----------------------------------------------------------------------------*/
static void BEKEN_I2c_Write(u8 reg, u8 *pBuf, u8 num) AT(BK1080_CODE)
{
    reg = reg<<1;
...
*/
/*----------------------------------------------------------------------------*/
static void init_BK1080(void) AT(BK1080_CODE)
{
    u8 temp[2];
...
*/
/*----------------------------------------------------------------------------*/
static void BK1080_SetFreq(u16 curFreq) AT(BK1080_CODE)
{
    u8 curChan;
    u16 temp;
...
*/
/*----------------------------------------------------------------------------*/
static bool set_fre_BK1080(u16 freq) AT(BK1080_CODE)
{
...
*/
/*----------------------------------------------------------------------------*/
static void BK1080_PowerDown(void) AT(BK1080_CODE)
{
    u16 temp = 0x4102;
...
*/
/*----------------------------------------------------------------------------*/
static void BK1080_mute(u8 flag) AT(BK1080_CODE)
{
    u8 TmpData8[2];
...
*/
/*----------------------------------------------------------------------------*/
static bool BK1080_Read_ID(void) AT(BK1080_CODE)
{
    u16 bk_id;
